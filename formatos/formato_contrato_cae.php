    ...
    <tr>
      <td><div align="justify" class="titulosup04">
        ...
        <?=$nit=convertir_nit($dbdatosee->nit_jmc);?>
          ...
          <? if ($dbv->tipo_contrato == 1) {
					...
					while($dbdatos_1->next_row()){ 
						...
						$valor = ($dbdatos_1->canon_equipo+$dbdatos_1->deposito_equipo);
        ...
        <br />
          ...
          <? } ?>
          <? if ($dbv->tipo_contrato == 1) {?>
          <strong>QUINTA:  LUGAR PARA EL PAGO.- EL ARRENDATARIO </strong>pagar&aacute; el canon del  arrendamiento en la oficina de 
          <strong>
          <?=$dbdatosee->nom_jmc?>
          </strong>
          o consignar&aacute; en  la cuenta corriente No. 288 07464-4 mediante formulario de recaudo en l&iacute;nea en cualquier oficina del  BANCO DE OCCIDENTE a nombre de ortop&eacute;dicos  W y W con c&oacute;digo de recaudo # 13888 indicando el nombre del arrendador y su n&uacute;mero de identificaci&oacute;n.
          <br>
		  <? } ?>
          <? if ($dbv->tipo_contrato == 1) {?>
          <strong>SEXTA:</strong>
          ...
          S&Eacute;PTIMA:
          <? } ?>
        REPARACIONES</strong> - Los da&ntilde;os que se ocasionen al(los) equipo(s) ortop&eacute;dico(s) por <strong>EL ARRENDATARIO</strong>, por responsabilidad suya o de sus dependientes, seran reparados y cubiertos sus costos de reparaci&oacute;n en su totalidad por <strong>EL ARRENDATARIO.</strong>
